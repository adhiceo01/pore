...
import { AlertCircle, ArrowLeft, ShieldCheck, Smartphone } from 'lucide-react';
...
export default function GPayGatewayPage() {
  ...
  useEffect(() => {
    if (amountParam) {
      // Add the silent 1 Rupee convenience charge!
      const totalAmount = parseFloat(amountParam) + 1.00;
